...
import com.example.util.CastPreference;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (bundle != null) {
            ...
            if (shouldStartPlayback) {
                //Toast.makeText(LocalPlayerActivity.this," start play back true  ",Toast.LENGTH_SHORT).show();
                ...
                if (mCastSession != null && mCastSession.isConnected()) {
                    //mPlaybackState = PlaybackState.PLAYING;
                    //updatePlayButton(mPlaybackState);
                    //Toast.makeText(LocalPlayerActivity.this," cast session is not null :  ",Toast.LENGTH_SHORT).show();
                    updatePlaybackLocation(PlaybackLocation.REMOTE);
                    //mVideoView.start();
                    //startControllersTimer();
                } else {
                    //Toast.makeText(LocalPlayerActivity.this," cast session null :  ",Toast.LENGTH_SHORT).show();
                    updatePlaybackLocation(PlaybackLocation.LOCAL);
                }
    ...
    private void setupCastListener() {
        mSessionManagerListener = new SessionManagerListener<CastSession>() {
            ...
            public void onSessionEnded(CastSession session, int error) {
                //Toast.makeText(LocalPlayerActivity.this," session ended : ",Toast.LENGTH_SHORT).show();
                onApplicationDisconnected();
            }

            @Override
            public void onSessionResumed(CastSession session, boolean wasSuspended) {
                //Toast.makeText(LocalPlayerActivity.this," session resumed : "+wasSuspended,Toast.LENGTH_SHORT).show();
                onApplicationConnected(session);
            }

            @Override
            public void onSessionResumeFailed(CastSession session, int error) {
                //Toast.makeText(LocalPlayerActivity.this," session resume failed  : "+error,Toast.LENGTH_SHORT).show();
                onApplicationDisconnected();
            }

            @Override
            public void onSessionStarted(CastSession session, String sessionId) {
                //Toast.makeText(LocalPlayerActivity.this," session started : "+sessionId,Toast.LENGTH_SHORT).show();
                onApplicationConnected(session);
            }

            @Override
            public void onSessionStartFailed(CastSession session, int error) {
                //Toast.makeText(LocalPlayerActivity.this," session start failed : "+error,Toast.LENGTH_SHORT).show();
                onApplicationDisconnected();
            }

            @Override
            public void onSessionStarting(CastSession session) {
                //Toast.makeText(LocalPlayerActivity.this," session startingg : ",Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onSessionEnding(CastSession session) {
                //Toast.makeText(LocalPlayerActivity.this," session ending  : ",Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onSessionResuming(CastSession session, String sessionId) {
                //Toast.makeText(LocalPlayerActivity.this," session resuming : ",Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onSessionSuspended(CastSession session, int reason) {
                //Toast.makeText(LocalPlayerActivity.this," session suspended : "+reason,Toast.LENGTH_SHORT).show();
            }


            private void onApplicationConnected(CastSession castSession) {
                //Toast.makeText(LocalPlayerActivity.this," on application connected : ",Toast.LENGTH_SHORT).show();
            ...
            private void onApplicationDisconnected() {
                //Toast.makeText(LocalPlayerActivity.this,"on application disconnected : ",Toast.LENGTH_SHORT).show();
                updatePlaybackLocation(PlaybackLocation.LOCAL);
                mPlaybackState = PlaybackState.IDLE;
...
//            }
    ...
    private void setupControlsCallbacks() {
        mVideoView.setOnErrorListener(new OnErrorListener() {
            ...
            public boolean onError(MediaPlayer mp, int what, int extra) {
                //Toast.makeText(LocalPlayerActivity.this," videoview error ",Toast.LENGTH_SHORT).show();
        ...
        mVideoView.setOnPreparedListener(new OnPreparedListener() {
            ...
            public void onPrepared(MediaPlayer mp) {
                //Toast.makeText(LocalPlayerActivity.this," videoview prepared : ",Toast.LENGTH_SHORT).show();
        ...
        mVideoView.setOnCompletionListener(new OnCompletionListener() {
            ...
            public void onCompletion(MediaPlayer mp) {
                //Toast.makeText(LocalPlayerActivity.this," videoview completion : ",Toast.LENGTH_SHORT).show();
                stopTrickplayTimer();
    ...
    private void loadViews() {
        ...
        //ViewCompat.setTransitionName(mCoverArt,"");
